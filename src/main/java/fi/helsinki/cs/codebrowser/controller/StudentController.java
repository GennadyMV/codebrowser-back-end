...
public class StudentController {
    ...
    public Collection<Student> list(@PathVariable final String courseId, @PathVariable final String exerciseId) throws IOException {
    ...
    public Student read(@PathVariable final String courseId, @PathVariable final String studentId) throws IOException {
